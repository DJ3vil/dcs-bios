...
--- @field c130j_cni_debug boolean? whether every rendered C-130J CNI-MU page should be written to Logs/DCS-BIOS-C-130J-CNI.log, and what the other displays report to Logs/DCS-BIOS-C-130J-Indicators.log
